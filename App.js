...
import './styles.css'; // Replace with your actual CSS file path
...
const Header = () => {
  return (
    <div className="header">
        <div>
          <img className = "logo" src = "https://static.vecteezy.com/system/resources/previews/002/303/696/large_2x/burger-logo-design-free-vector.jpg"></img>
        </div>
...
const RestaurantCard = (props) => {
  const {resData} = props;
  const {name , cuisines , avgRating , deliveryTime , costForTwo , cloudinaryImageId} = resData?.data; ///did optional chaining here
